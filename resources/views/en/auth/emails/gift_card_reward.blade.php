                                        ...
                                        <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                                            ...
                                            <div style="font-size:16px;text-align:center;font-family:Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif">
                                                <div style="padding: 12px 0;background: #252F5A;">
                                                    <h1 style="color:#fff;margin:0;display: flex;width:100%;"><img src="<?php echo URL::to('/'); ?>/images/logo_white.png" alt="Logo" style="width: 100px;margin-right: 0.9rem; margin-left: 13px;"><span style="margin-left: 50px;">Gift card</span></h1>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <p style="line-height: 1.5; word-break: break-word; text-align: left; font-family: Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; font-size: 16px; mso-line-height-alt: 24px; margin: 0;">
                                                        <span style="font-size: 16px;">
                                                            <span style="color: #252f5a; text-align: center;display: inline-block;">
                                                                <h6 style="font-size: 13px; color: #252f5a; text-align: center; margin: 0.5rem 0;">You have earned a gift card!.<h6>
                                                                <h6 style="font-size: 13px; color: #252f5a; text-align: center; margin: 0.5rem 0;">The details of the gift card are:<h6>
                                                                <h6 style="font-size: 20px; font-weight: bold; color: #252f5a; text-align: center; margin: 0.5rem 0;">Gift card details</h6>
                                                                <table style="margin: 0 auto 1.5rem;">
                                                                    <tbody style="color: #252f5a;">
                                                                        <tr>
                                                                            <td rowspan="3">
                                                                            <?php if(!empty($gift_card_image)){ ?><img  src="{{ $gift_card_image }}" alt="Gift card icon" style="width:80px;"> <?php } ?>
                                                                            </td>
                                                                            <td style="padding-left: 10px;">Gift card name: {{ $gift_card_type }} GIFT CARD</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="padding-left: 10px;">Redeem code: <b>{{  $gift_card_code }}</b></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="padding-left: 10px;">Gift card amount: <b>{{  $card_amount }}</b></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </span>
                                                            <?php if(!empty($redeem_link)){ ?>
                                                            <span style="color: #252f5a;line-height: 1.5;word-break: break-word;text-align: left;font-family: Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size: 16px;margin: 0;">
                                                                You can redeem the code from the link
                                                                <a href="{{ $redeem_link }}" style="color: #252f5a;text-decoration: underline;padding-left: 5px;">Redeem your gift card code from here</a><br><br>
                                                            </span>
                                                            <?php } ?>
                                                            <span style="color: #252f5a;line-height: 1.5;word-break: break-word;text-align: left;font-family: Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size: 16px;margin: 0;">
                                                                If you have any queries, please contact our support team at<a href="mailto:support@dropforcoin.com" style="color: #252f5a;text-decoration: underline;padding-left: 5px;">support@dropforcoin.com</a><br><br>
                                                            </span>
                                                        </span>
                                                    </p>
                                                </div>
