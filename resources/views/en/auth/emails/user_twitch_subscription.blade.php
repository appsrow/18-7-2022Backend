                                        ...
                                        <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                                            ...
                                            <div style="font-size:16px;text-align:center;font-family:Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif">
                                                <div style="padding: 12px 0;background: #252F5A;">
                                                    <h1 style="color:#fff;margin:0;display: flex;width:100%;"><img src="<?php echo URL::to('/'); ?>/images/logo_white.png" alt="Logo" style="width: 100px;margin-right: 0.9rem; margin-left: 13px;"><span style="margin-left: 50px;">Twitch subscription</span></h1>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                                            <div style="color:#555555;font-family:Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;line-height:1.5;padding-top:15px;padding-right:40px;padding-bottom:10px;padding-left:40px;">
                                                <div style="line-height: 1.5; font-size: 12px; font-family: Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; color: #555555; mso-line-height-alt: 18px;">
                                                    <p style="text-align: center; line-height: 1.5; word-break: break-word; font-family: Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; font-size: 16px; mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 24px;color: #252f5a;font-weight: bold;">Hey <?= $user_name ?>!</span></p>
                                                </div>
                                            </div>
                                            <!-- <table border="0" cellpadding="0" cellspacing="0" class="divider" role="presentation" style="table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;" valign="top" width="100%">
                                                <tbody>
                                                    ...
                                                    <p style="line-height: 1.5; word-break: break-word; text-align: left; font-family: Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; font-size: 16px; mso-line-height-alt: 24px; margin: 0;">
                                                        <span style="font-size: 16px;">
                                                            <span style="color: #252f5a; text-align: center;display: inline-block;">
                                                                ...
                                                                Your Twitch subscription is on its way.<br><br>
                                                                The process can take between 24 and 72 hours. Please, we kindly ask you to be patient, you will soon be able to enjoy your Twitch subscription.<br><br>
                                                                <h6 style="font-size: 20px; font-weight: bold; color: #252f5a; text-align: center; margin: 0.5rem 0;">Order details</h6>
                                                                <table style="margin: 0 auto 1.5rem;">
                                                                    <tbody style="color: #252f5a;">
                                                                        <tr>
                                                                            ...
                                                                            <td style="padding-left: 10px;">Twitch subscription</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="padding-left: 10px;">Channel: <b><?= $streamer_name ?></b></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="padding-left: 10px;">Twitch user: <b><?= $user_twitch_id ?></b></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </span>
                                                            <span style="color: #252f5a;line-height: 1.5;word-break: break-word;text-align: left;font-family: Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size: 16px;margin: 0;">
                                                                If after this time you have not received your subscription, please contact our support team at<a href="mailto:support@dropforcoin.com" style="color: #252f5a;text-decoration: underline;padding-left: 5px;">support@dropforcoin.com</a><br><br>
                                                            </span>
                                                        </span>
                                                    </p>
                                                </div>
