		...
		<tbody>
			...
			<tr>
				...
				<td colspan="3" style="padding: 15px 0px;vertical-align: top;border-left: 0;">
					<h3 align="right" valign=bottom style="margin: 0 0 7px 0;color: #000;"><b>FACTURA</b></h3>
			...
			<tr>
				...
				<td colspan="4" align="right" style="padding: 15px 0px 0 30px;vertical-align: top; width:30%;">
					<h3 align="left" valign=bottom style="margin: 0 0 7px 0;color: #000;white-space: pre;"><b>Dirección de Envio</b></h3>
			...
			<tr>
				<td colspan="2" align="center" valign=bottom bgcolor="#cccccc" style="padding: 5px; border: 1px solid #bbb;border-right: none; white-space: pre;color: #000;"><b>Número de factura</b></td>
				<td colspan="2" align="center" valign=bottom bgcolor="#cccccc" style="padding: 5px; border: 1px solid #bbb; border-right: none; white-space: pre; color: #000;"><b>Fecha de la factura</b></td>
				<td colspan="2" align="center" valign=bottom bgcolor="#cccccc" style="padding: 5px; border: 1px solid #bbb;border-right: none; white-space: pre; color: #000;"><b>Identificación de referencia</b></td>
				<td colspan="2" align="center" valign=bottom bgcolor="#cccccc" style="padding: 5px; border: 1px solid #bbb; white-space: pre; color: #000;"><b>Fecha de orden</b></td>
			</tr>
			<!-- <tr>
			...
			<tr>
				<td colspan="5" align="left" valign=bottom bgcolor="#cccccc" style="padding: 5px; border: 1px solid #bbb;border-right: none; white-space: pre;color: #000;"><b>Producto</b></td>
			...
			<tr>
				<td colspan="5" align="left" valign=bottom bgcolor="#ffffff" style="padding: 5px; border: 1px solid #bbb; border-right: none; border-top: none; color: #333;">
					...
					<span>CAC es {{ $show->cac }} y Objetivos de la campaña es {{ $show->user_target }} </span>
				</td>
			...
			<tr>
				...
				<td colspan="2" align="left" valign=bottom bgcolor="#eee" style="padding: 5px; border: 1px solid #bbb; border-right: none; border-top: none; white-space: pre; color:#000;">Monto</td>
			...
			<tr>
				...
				<td colspan="2" align="left" valign=bottom bgcolor="#eee" style="padding: 5px; border: 1px solid #bbb; border-right: none; border-top: none; white-space: pre; color:#000;">Impuesto </td>
