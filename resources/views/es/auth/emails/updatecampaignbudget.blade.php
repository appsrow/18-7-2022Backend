        ...
        <p style="line-height: 1.5; word-break: break-word; text-align: left; font-family: Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; font-size: 16px; mso-line-height-alt: 24px; margin: 0;">
            <span style="font-size: 16px;">
                <span style="color: #252f5a;">
                    ...
                    Se ha aumentado el presupuesto para el <?php if (!empty($campaign_name)) {
                                                                echo $campaign_name;
                                                            } ?> Campaña.<br><br>


                    Nosotras hemos recibido un pago de €<?php if (!empty($grand_total)) {
                                                            echo $grand_total;
                                                        } ?> (impuesto incluido).
                    Encuentre la factura en el archivo adjunto..<br><br>


                    Para obtener más detalles, puede <a href="<?php echo env("EMAIL_WEBSITE_URL", null); ?>/brand/login" target="_blank"> Iniciar sesión </a> y comprobar.<br><br>
